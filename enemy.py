...
class SmallEnemy(pygame.sprite.Sprite):
    def __init__(self,bg_size):
        ...
        self.mask = pygame.mask.from_surface(self.image)    #将非透明的部分加以检测
...
class MidEnemy(pygame.sprite.Sprite):
    ...
    def __init__(self,bg_size):
        ...
        self.speed = 1
        self.active = True 
        self.rect.left,self.rect.top = randint(0,self.width - self.rect.width), randint(-10 * self.height,-self.height)#至少一个屏幕后才出现中型机
        self.mask = pygame.mask.from_surface(self.image)    #将非透明的部分加以检测
...
class BigEnemy(pygame.sprite.Sprite):
    ...
    def __init__(self,bg_size):
        ...
        self.width,self.height = bg_size[0],bg_size[1]
        self.speed = 1
        self.active = True      #True表示飞机还活着
        self.rect.left,self.rect.top = \
                       randint(0,self.width - self.rect.width), \
                       randint(-15 * self.height,-5 * self.height)
        #至少一个屏幕后才出现大型机
        self.mask = pygame.mask.from_surface(self.image1)    #将非透明的部分加以检测
